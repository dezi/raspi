...
mkfifo Kappa.inp.1.2.vr.size~720x576.y4m
mkfifo Kappa.inp.1.2.ar.ac~2.ar~48000.s16le
...
ffmpeg -y \
	-f s16le -ac 2 -ar 48000 -probesize 32 -i Kappa.inp.1.2.ar.ac~2.ar~48000.s16le \
	-f yuv4mpegpipe                        -i Kappa.inp.1.2.vr.size~720x576.y4m \
